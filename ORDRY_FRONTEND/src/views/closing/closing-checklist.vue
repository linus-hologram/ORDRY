<template>
  <div class="wrapper">
    ...
    <div class="check-list">
      ...
      <checkListItem
        @check="allDone()"
        v-for="item in secondSectionItems"
        :key="item._id"
        :info="item.title"
        :img="item.imageId"
      ></checkListItem>
...
export default {
  ...
  computed: {
    ...mapGetters("checklist", ["secondSectionItems"]) // make use of the vuex store getter for the firstSectionItems
  },
  methods: {
    allDone() {
